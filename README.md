...
Ganesh `IS` an `Accountable`, `Responsible`, and `Ethical` programmer. Learnings and Earnings will happen life long and are important. Do not forget the ethics, and compassion.
